...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'html/example_2d_cat_witch.data';
      var REMOTE_PACKAGE_BASE = 'example_2d_cat_witch.data';
...
Module['FS_createPath']('/assets', 'example_2d_cat_witch', true, true);
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_html/example_2d_cat_witch.data');

      };
      Module['addRunDependency']('datafile_html/example_2d_cat_witch.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 569302, "filename": "/assets/example_2d_cat_witch/cat.json"}, {"start": 569302, "audio": 0, "end": 572946, "filename": "/assets/example_2d_cat_witch/cat.atlas"}, {"start": 572946, "audio": 0, "end": 1076158, "filename": "/assets/example_2d_cat_witch/cat.png"}], "remote_package_size": 1076158, "package_uuid": "f90cc960-0019-4a10-afbb-44bf02c8861f"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5357616,
    DYNAMIC_BASE = 5357616,
    DYNAMICTOP_PTR = 114544;
...
var wasmBinaryFile = 'example_2d_cat_witch.wasm';
