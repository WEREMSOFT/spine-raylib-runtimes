...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'html/example_3d.data';
      var REMOTE_PACKAGE_BASE = 'example_3d.data';
...
Module['FS_createPath']('/assets', 'example_3d', true, true);
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_html/example_3d.data');

      };
      Module['addRunDependency']('datafile_html/example_3d.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 4224, "filename": "/assets/example_3d/NewDragon.atlas"}, {"start": 4224, "audio": 0, "end": 199053, "filename": "/assets/example_3d/dragon2.png"}, {"start": 199053, "audio": 0, "end": 232015, "filename": "/assets/example_3d/NewDragon.json"}, {"start": 232015, "audio": 0, "end": 860552, "filename": "/assets/example_3d/dragon.png"}], "remote_package_size": 860552, "package_uuid": "f7949acb-7fc5-46dc-8e66-588e602bdb8f"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5358192,
    DYNAMIC_BASE = 5358192,
    DYNAMICTOP_PTR = 115120;
...
var wasmBinaryFile = 'example_3d.wasm';
