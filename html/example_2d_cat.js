...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'html/example_2d_cat.data';
      var REMOTE_PACKAGE_BASE = 'example_2d_cat.data';
...
Module['FS_createPath']('/assets', 'example_2d_cat', true, true);
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_html/example_2d_cat.data');

      };
      Module['addRunDependency']('datafile_html/example_2d_cat.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 1740, "filename": "/assets/example_2d_cat/hero.atlas"}, {"start": 1740, "audio": 0, "end": 74908, "filename": "/assets/example_2d_cat/hero.png"}, {"start": 74908, "audio": 0, "end": 321370, "filename": "/assets/example_2d_cat/hero.json"}], "remote_package_size": 321370, "package_uuid": "1ffeb476-3ebd-4e50-8260-0f346fca49f8"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5368432,
    DYNAMIC_BASE = 5368432,
    DYNAMICTOP_PTR = 125360;
...
var wasmBinaryFile = 'example_2d_cat.wasm';
