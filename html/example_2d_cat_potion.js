...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'html/example_2d_cat_potion.data';
      var REMOTE_PACKAGE_BASE = 'example_2d_cat_potion.data';
...
Module['FS_createPath']('/assets', 'example_2d_cat_potion', true, true);
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_html/example_2d_cat_potion.data');

      };
      Module['addRunDependency']('datafile_html/example_2d_cat_potion.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 4620, "filename": "/assets/example_2d_cat_potion/cat_potion.atlas"}, {"start": 4620, "audio": 0, "end": 283666, "filename": "/assets/example_2d_cat_potion/cat_potion.json"}, {"start": 283666, "audio": 0, "end": 827142, "filename": "/assets/example_2d_cat_potion/cat_potion.png"}], "remote_package_size": 827142, "package_uuid": "2de923ab-3cb6-4303-842e-46faee2638bf"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5357568,
    DYNAMIC_BASE = 5357568,
    DYNAMICTOP_PTR = 114496;
...
var wasmBinaryFile = 'example_2d_cat_potion.wasm';
