...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'html/example_2d.data';
      var REMOTE_PACKAGE_BASE = 'example_2d.data';
...
Module['FS_createPath']('/assets', 'example_2d', true, true);
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_html/example_2d.data');

      };
      Module['addRunDependency']('datafile_html/example_2d.data');
   ...
   loadPackage({"files": [{"start": 0, "audio": 0, "end": 4224, "filename": "/assets/example_2d/NewDragon.atlas"}, {"start": 4224, "audio": 0, "end": 199053, "filename": "/assets/example_2d/dragon2.png"}, {"start": 199053, "audio": 0, "end": 232015, "filename": "/assets/example_2d/NewDragon.json"}, {"start": 232015, "audio": 0, "end": 860552, "filename": "/assets/example_2d/dragon.png"}], "remote_package_size": 860552, "package_uuid": "b2df1d3f-e588-4696-b057-08dcfc542ca7"});
...
var wasmBinaryFile = 'example_2d.wasm';
