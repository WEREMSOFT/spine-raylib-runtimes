...
(function () {
    ...
    loadPackage({
        "files": [{"start": 0, "audio": 0, "end": 10495, "filename": "/assets/scarfy.png"}, {
            "start": 10495,
            "audio": 0,
            "end": 25922,
...
var wasmMemory;
var wasmTable = new WebAssembly.Table({"initial": 225, "maximum": 225 + 0, "element": "anyfunc"});
var ABORT = false;
var EXITSTATUS = 0;
...
var asmLibraryArg = {
    ...
    "p": _abs,
    "R": _clock_gettime,
    "y": _eglGetProcAddress,
    "F": _emscripten_exit_pointerlock,
    "W": _emscripten_get_gamepad_status,
    "X": _emscripten_get_num_gamepads,
    "E": _emscripten_get_pointerlock_status,
    "Dd": _emscripten_glActiveTexture,
    "Cd": _emscripten_glAttachShader,
    "Td": _emscripten_glBeginQueryEXT,
    "Bd": _emscripten_glBindAttribLocation,
    "Ad": _emscripten_glBindBuffer,
    "zd": _emscripten_glBindFramebuffer,
    "yd": _emscripten_glBindRenderbuffer,
    "xd": _emscripten_glBindTexture,
    "Ld": _emscripten_glBindVertexArrayOES,
    "wd": _emscripten_glBlendColor,
    "vd": _emscripten_glBlendEquation,
    "ud": _emscripten_glBlendEquationSeparate,
    "td": _emscripten_glBlendFunc,
    "sd": _emscripten_glBlendFuncSeparate,
    "rd": _emscripten_glBufferData,
    "qd": _emscripten_glBufferSubData,
    "pd": _emscripten_glCheckFramebufferStatus,
    "od": _emscripten_glClear,
    "nd": _emscripten_glClearColor,
    "md": _emscripten_glClearDepthf,
    "ld": _emscripten_glClearStencil,
    ...
    "ad": _emscripten_glDeleteBuffers,
    "_c": _emscripten_glDeleteFramebuffers,
    "Zc": _emscripten_glDeleteProgram,
    "Vd": _emscripten_glDeleteQueriesEXT,
    "Yc": _emscripten_glDeleteRenderbuffers,
    "Xc": _emscripten_glDeleteShader,
    "Wc": _emscripten_glDeleteTextures,
    "Kd": _emscripten_glDeleteVertexArraysOES,
    "Vc": _emscripten_glDepthFunc,
    "Uc": _emscripten_glDepthMask,
    "Tc": _emscripten_glDepthRangef,
    "Sc": _emscripten_glDetachShader,
    "Rc": _emscripten_glDisable,
    "Pc": _emscripten_glDisableVertexAttribArray,
    "Oc": _emscripten_glDrawArrays,
    "Gd": _emscripten_glDrawArraysInstancedANGLE,
    "Hd": _emscripten_glDrawBuffersWEBGL,
    "Nc": _emscripten_glDrawElements,
    "Fd": _emscripten_glDrawElementsInstancedANGLE,
    "Mc": _emscripten_glEnable,
    "Lc": _emscripten_glEnableVertexAttribArray,
    ...
    "Ec": _emscripten_glGenBuffers,
    "Cc": _emscripten_glGenFramebuffers,
    "Wd": _emscripten_glGenQueriesEXT,
    "Bc": _emscripten_glGenRenderbuffers,
    "Ac": _emscripten_glGenTextures,
    "Jd": _emscripten_glGenVertexArraysOES,
    "Dc": _emscripten_glGenerateMipmap,
    ...
    "Pd": _emscripten_glGetQueryObjectivEXT,
    "Md": _emscripten_glGetQueryObjectui64vEXT,
    "Od": _emscripten_glGetQueryObjectuivEXT,
    "Qd": _emscripten_glGetQueryivEXT,
    ...
    "Zb": _emscripten_glGetVertexAttribPointerv,
    "ac": _emscripten_glGetVertexAttribfv,
    "$b": _emscripten_glGetVertexAttribiv,
    "Yb": _emscripten_glHint,
    "Xb": _emscripten_glIsBuffer,
    "Wb": _emscripten_glIsEnabled,
    "Vb": _emscripten_glIsFramebuffer,
    "Ub": _emscripten_glIsProgram,
    "Ud": _emscripten_glIsQueryEXT,
    "Tb": _emscripten_glIsRenderbuffer,
    "Sb": _emscripten_glIsShader,
    "Rb": _emscripten_glIsTexture,
    "Id": _emscripten_glIsVertexArrayOES,
    "Qb": _emscripten_glLineWidth,
    "Ob": _emscripten_glLinkProgram,
    "Nb": _emscripten_glPixelStorei,
    "Mb": _emscripten_glPolygonOffset,
    "Rd": _emscripten_glQueryCounterEXT,
    "Lb": _emscripten_glReadPixels,
    "Kb": _emscripten_glReleaseShaderCompiler,
    "Jb": _emscripten_glRenderbufferStorage,
    "Ib": _emscripten_glSampleCoverage,
    "Hb": _emscripten_glScissor,
    "Gb": _emscripten_glShaderBinary,
    "Fb": _emscripten_glShaderSource,
    ...
    "$a": _emscripten_glUniformMatrix3fv,
    "_a": _emscripten_glUniformMatrix4fv,
    "Za": _emscripten_glUseProgram,
    "Ya": _emscripten_glValidateProgram,
    "Xa": _emscripten_glVertexAttrib1f,
    "Wa": _emscripten_glVertexAttrib1fv,
    "Va": _emscripten_glVertexAttrib2f,
    "Ua": _emscripten_glVertexAttrib2fv,
    "Ta": _emscripten_glVertexAttrib3f,
    "Sa": _emscripten_glVertexAttrib3fv,
    "Ra": _emscripten_glVertexAttrib4f,
    "Qa": _emscripten_glVertexAttrib4fv,
    "Ed": _emscripten_glVertexAttribDivisorANGLE,
    ...
    "m": _glUseProgram,
    "La": _glVertexAttrib2f,
    "Ma": _glVertexAttrib3f,
    "r": _glVertexAttrib4f,
